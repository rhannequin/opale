...
# source://rubocop/1.35.1/lib/rubocop/cop/mixin/configurable_naming.rb#10
...
# source://rubocop/1.35.1/lib/rubocop/cop/mixin/configurable_numbering.rb#11
...
class RuboCop::Cop::Lint::AssignmentInCondition < ::RuboCop::Cop::Base
  ...
  # source://rubocop/1.35.1/lib/rubocop/cop/lint/assignment_in_condition.rb#49
  def on_if(node); end
  ...
  # source://rubocop/1.35.1/lib/rubocop/cop/lint/assignment_in_condition.rb#72
  def allowed_construct?(asgn_node); end

  # source://rubocop/1.35.1/lib/rubocop/cop/lint/assignment_in_condition.rb#76
  def conditional_assignment?(asgn_node); end

  # source://rubocop/1.35.1/lib/rubocop/cop/lint/assignment_in_condition.rb#80
  def skip_children?(asgn_node); end

  # source://rubocop/1.35.1/lib/rubocop/cop/lint/assignment_in_condition.rb#86
  def traverse_node(node, &block); end
end

# source://rubocop/1.35.1/lib/rubocop/cop/lint/assignment_in_condition.rb#47
RuboCop::Cop::Lint::AssignmentInCondition::ASGN_TYPES = T.let(T.unsafe(nil), Array)

# source://rubocop/1.35.1/lib/rubocop/cop/lint/assignment_in_condition.rb#44
RuboCop::Cop::Lint::AssignmentInCondition::MSG_WITHOUT_SAFE_ASSIGNMENT_ALLOWED = T.let(T.unsafe(nil), String)

# source://rubocop/1.35.1/lib/rubocop/cop/lint/assignment_in_condition.rb#40
...
# source://rubocop/1.35.1/lib/rubocop/options.rb#469
RuboCop::OptionsHelp::FORMATTER_OPTION_LIST = T.let(T.unsafe(nil), Array)

# source://rubocop/1.35.1/lib/rubocop/options.rb#468
RuboCop::OptionsHelp::MAX_EXCL = T.let(T.unsafe(nil), String)

# source://rubocop/1.35.1/lib/rubocop/options.rb#471
...
class Standard::MergesSettings
  ...
  # source://standard//lib/standard/merges_settings.rb#49
  ...
  # source://standard//lib/standard/merges_settings.rb#59
